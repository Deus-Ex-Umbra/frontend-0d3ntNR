...
export default function TratamientosMobile() {
  ...
  return (
    <div className="flex flex-row h-screen overflow-hidden bg-gradient-to-br from-background via-background to-secondary/20">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-4 md:p-8 space-y-6 md:space-y-8">
          <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4 md:gap-0">
            ...
            <Button
              size="default"
              className="shadow-lg hover:shadow-[0_0_20px_rgba(59,130,246,0.4)] hover:scale-105 transition-all duration-200 self-end md:self-auto"
                  ...
                  {cargando_planes ? (
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground max-w-md mx-auto">
                          {busqueda_planes || paciente_filtro !== 'todos'
                            ...
                            : 'Asigna plantillas a pacientes desde Plantillas'
                          }
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      {planes_filtrados.map((plan) => {
                        ...
                        const saldo_pendiente = plan.costo_total - plan.total_abonado;

                        return (
                          <div
                            key={plan.id}
                            className="p-4 md:p-6 rounded-lg border-2 border-border bg-secondary/30 hover:bg-secondary/50 hover:scale-[1.02] hover:shadow-md transition-all duration-200 cursor-pointer"
                          ...
                          >
                            <div className="flex flex-col md:flex-row items-start justify-between mb-4 gap-4 md:gap-0">
                              ...
                              <Badge
                                variant={progreso === 100 ? "default" : "secondary"}
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                                ...
                                <div className="space-y-1">
                                  ...
                                  <p className={`font-semibold ${saldo_pendiente > 0 ? "text-red-500" : "text-green-500"}`}>
                                    {formatearMoneda(saldo_pendiente)}
                                  </p>
                                </div>
                              </div>

                              <div className="flex flex-col md:flex-row items-start md:items-center gap-4 text-xs text-muted-foreground pt-2 border-t border-border">
                                <div className="flex items-center gap-1">
                                  <Calendar className="h-3 w-3" />
                                  {plan.citas?.length || 0} citas
                                </div>
                                <div className="flex items-center gap-1">
      ...
      <Dialog open={dialogo_plantilla_abierto} onOpenChange={setDialogoPlantillaAbierto}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle>
              {modo_edicion ? "Editar Plantilla" : "Nueva Plantilla"}
            </DialogTitle>
            <DialogDescription>
              {modo_edicion ? "Modifica la plantilla" : "Crea una plantilla"}
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setFormularioPlantilla({ ...formulario_plantilla, nombre: e.target.value })}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="numero_citas">Citas *</Label>
                <Input
                  id="numero_citas"
                  type="number"
                  min="1"
                  value={formulario_plantilla.numero_citas}
                  onChange={(e) => setFormularioPlantilla({ ...formulario_plantilla, numero_citas: e.target.value })}
                  placeholder="25"
                  className="hover:border-primary/50 focus:border-primary transition-all duration-200"
                />
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="costo_total">Costo (Bs.) *</Label>
                <Input
                  id="costo_total"
                  type="number"
                  step="0.01"
                  ...
                  onChange={(e) => setFormularioPlantilla({ ...formulario_plantilla, costo_total: e.target.value })}
                  placeholder="5000.00"
                  className="hover:border-primary/50 focus:border-primary transition-all duration-200"
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="space-y-2">
                  <Label htmlFor="intervalo_meses" className="text-xs text-muted-foreground">Meses</Label>
                  <Input
                    id="intervalo_meses"
                    type="number"
                    min="0"
                    value={formulario_plantilla.intervalo_meses}
                    onChange={(e) => setFormularioPlantilla({ ...formulario_plantilla, intervalo_meses: e.target.value })}
                    placeholder="0"
                    className="hover:border-primary/50 focus:border-primary transition-all duration-200"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="intervalo_semanas" className="text-xs text-muted-foreground">Semanas</Label>
                  <Input
                    id="intervalo_semanas"
                    type="number"
                    min="0"
                    value={formulario_plantilla.intervalo_semanas}
                    onChange={(e) => setFormularioPlantilla({ ...formulario_plantilla, intervalo_semanas: e.target.value })}
                    placeholder="0"
                    className="hover:border-primary/50 focus:border-primary transition-all duration-200"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="intervalo_dias" className="text-xs text-muted-foreground">Días</Label>
                  <Input
                    id="intervalo_dias"
                    type="number"
                    min="0"
                    value={formulario_plantilla.intervalo_dias}
                    onChange={(e) => setFormularioPlantilla({ ...formulario_plantilla, intervalo_dias: e.target.value })}
                    placeholder="0"
                    className="hover:border-primary/50 focus:border-primary transition-all duration-200"
                  />
                </div>
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="horas_aproximadas_citas" className="text-xs text-muted-foreground">Horas</Label>
                  <Input
                    id="horas_aproximadas_citas"
                    type="number"
                    min="0"
                    value={formulario_plantilla.horas_aproximadas_citas}
                    onChange={(e) => setFormularioPlantilla({ ...formulario_plantilla, horas_aproximadas_citas: e.target.value })}
                    placeholder="0"
                    className="hover:border-primary/50 focus:border-primary transition-all duration-200"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="minutos_aproximados_citas" className="text-xs text-muted-foreground">Minutos</Label>
                  <Input
                    id="minutos_aproximados_citas"
                    type="number"
                    min="1"
                    value={formulario_plantilla.minutos_aproximados_citas}
                    onChange={(e) => setFormularioPlantilla({ ...formulario_plantilla, minutos_aproximados_citas: e.target.value })}
                    placeholder="30"
                    className="hover:border-primary/50 focus:border-primary transition-all duration-200"
                  />
                </div>
      ...
      <Dialog open={dialogo_asignar_abierto} onOpenChange={setDialogoAsignarAbierto}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle>Asignar Plan</DialogTitle>
            <DialogDescription>
              {tratamiento_seleccionado && `Asignar "${tratamiento_seleccionado.nombre}" a paciente`}
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <Combobox
                ...
                onChange={(valor) => setFormularioAsignar({ ...formulario_asignar, paciente_id: valor })}
            ...
            <div className="space-y-2">
              ...
              <DateTimePicker
                ...
                onChange={(fecha) => fecha && setFormularioAsignar({ ...formulario_asignar, fecha_inicio: fecha })}
              ...
              <div className="p-4 rounded-lg bg-secondary/30 border border-border space-y-2">
                ...
                <div className="space-y-1 text-sm text-muted-foreground">
                  <p className="flex items-center gap-2">
                    ...
                    {tratamiento_seleccionado.numero_citas} citas
                  </p>
                  <p className="flex items-center gap-2">
                    <Clock className="h-4 w-4" />
                  ...
                  <p className="flex items-center gap-2">
                    <Clock className="h-4 w-4" />
                    Duración: {formatearDuracion(tratamiento_seleccionado.horas_aproximadas_citas, tratamiento_seleccionado.minutos_aproximados_citas)}
                  </p>
                  <p className="flex items-center gap-2">
                    <DollarSign className="h-4 w-4" />
            ...
            <div className="p-3 rounded-lg bg-blue-500/10 border border-blue-500/20">
              <p className="text-xs text-blue-600 dark:text-blue-400 flex items-start gap-2">
                ...
                Validará conflictos de horario.
              </p>
            </div>
          </div>

          <DialogFooter className="flex-col sm:flex-row">
            <Button variant="outline" onClick={() => setDialogoAsignarAbierto(false)} disabled={guardando} className="w-full sm:w-auto">Cancelar</Button>
            <Button onClick={manejarAsignarTratamiento} disabled={guardando} className="w-full sm:w-auto">
              {guardando && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
              Asignar
            </Button>
          </DialogFooter>
      ...
      <Dialog open={dialogo_detalle_plan_abierto} onOpenChange={setDialogoDetallePlanAbierto}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Gestión del Plan</DialogTitle>
            <DialogDescription>Administra citas y pagos</DialogDescription>
          </DialogHeader>
            ...
            <div className="space-y-6">
              <div className="p-4 bg-secondary/30 rounded-lg">
                <h3 className="text-xl font-bold text-foreground mb-2">
                  {plan_seleccionado.paciente.nombre} {plan_seleccionado.paciente.apellidos}
                </h3>
                <p className="text-muted-foreground">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Card>
                  ...
                  <CardContent>
                    <p className="text-2xl font-bold">{formatearMoneda(plan_seleccionado.costo_total)}</p>
                  </CardContent>
                </Card>
                <Card>
                  <CardHeader className="pb-3">
                    <CardTitle className="text-sm text-muted-foreground">Abonado</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-2xl font-bold text-green-500">{formatearMoneda(plan_seleccionado.total_abonado)}</p>
                  </CardContent>
                </Card>
                <Card>
                  <CardHeader className="pb-3">
                  ...
                  <CardContent>
                    <p className="text-2xl font-bold text-red-500">{formatearMoneda(plan_seleccionado.costo_total - plan_seleccionado.total_abonado)}</p>
                  </CardContent>
                </Card>
              </div>
              ...
              <Tabs defaultValue="citas" className="w-full">
                <TabsList className="grid w-full grid-cols-2">
                  <TabsTrigger value="citas">Citas ({plan_seleccionado.citas.length})</TabsTrigger>
                  <TabsTrigger value="pagos">Pagos ({plan_seleccionado.pagos.length})</TabsTrigger>
                </TabsList>

                <TabsContent value="citas" className="space-y-3 mt-4">
                  <div className="flex justify-end">
                    <Button size="sm" onClick={abrirDialogoNuevaCita} className="hover:shadow-[0_0_15px_rgba(59,130,246,0.4)] hover:scale-105 transition-all duration-200">
                      <Plus className="h-4 w-4 mr-2" />
                      Agregar
                    </Button>
                  </div>
                  ...
                  {plan_seleccionado.citas.length === 0 ? (
                    ...
                    plan_seleccionado.citas.map((cita) => (
                      <div key={cita.id} className="p-4 rounded-lg bg-secondary/30 border border-border hover:bg-secondary/50 transition-all duration-200">
                        <div className="flex flex-col md:flex-row items-start justify-between gap-4 md:gap-0">
                          <div className="flex-1">
                            <div className="flex items-center gap-3 mb-2">
                              <Calendar className="h-4 w-4 text-muted-foreground" />
                              <p className="font-medium text-foreground">{formatearFechaHora(cita.fecha)}</p>
                              <Badge className={`${obtenerColorEstado(cita.estado_pago)} text-white`}>
                                {obtenerEtiquetaEstado(cita.estado_pago)}
                              </Badge>
                            </div>
                            <p className="text-sm text-muted-foreground ml-0 md:ml-7">{cita.descripcion}</p>
                            <div className="flex flex-col md:flex-row items-start md:items-center gap-3 ml-0 md:ml-7 mt-1">
                              ...
                              {cita.monto_esperado > 0 && (
                                <p className="text-xs text-muted-foreground flex items-center gap-1">
                                  <DollarSign className="h-3 w-3" />
                                  {formatearMoneda(cita.monto_esperado)}
                                </p>
                              )}
                            </div>
                          </div>
                          <div className="flex gap-2">
                            <Button variant="ghost" size="icon" onClick={() => abrirDialogoEditarCita(cita)} className="hover:bg-primary/20 hover:text-primary hover:scale-110 transition-all duration-200" title="Editar">
                              <Edit className="h-4 w-4" />
                            </Button>
                            <Button variant="ghost" size="icon" onClick={() => abrirDialogoConfirmarEliminarCita(cita)} className="hover:bg-destructive/20 hover:text-destructive hover:scale-110 transition-all duration-200" title="Eliminar">
                              <Trash2 className="h-4 w-4" />
                            </Button>
                          </div>
                        </div>
                ...
                <TabsContent value="pagos" className="space-y-3 mt-4">
                  {plan_seleccionado.pagos.length === 0 ? (
                    ...
                    plan_seleccionado.pagos.map((pago) => (
                      <div key={pago.id} className="p-3 rounded-lg bg-secondary/30 border border-border">
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="font-semibold text-green-500">{formatearMoneda(pago.monto)}</p>
                            <p className="text-sm text-muted-foreground">{formatearFecha(pago.fecha)}</p>
                          </div>
      ...
      <Dialog open={dialogo_cita_abierto} onOpenChange={setDialogoCitaAbierto}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle>{modo_edicion_cita ? 'Editar Cita' : 'Agregar Cita'}</DialogTitle>
            <DialogDescription>{modo_edicion_cita ? 'Modifica cita' : 'Programa nueva cita'}</DialogDescription>
          </DialogHeader>

          <div className="space-y-4 py-4">
            <div className="space-y-2">
              <Label htmlFor="fecha_cita">Fecha/Hora *</Label>
              <DateTimePicker valor={formulario_cita.fecha} onChange={(fecha) => setFormularioCita({ ...formulario_cita, fecha })} placeholder="Selecciona" />
            </div>

            <div className="space-y-2">
              <Label htmlFor="descripcion_cita">Descripción *</Label>
              <Textarea id="descripcion_cita" value={formulario_cita.descripcion} onChange={(e) => setFormularioCita({ ...formulario_cita, descripcion: e.target.value })} placeholder="Ej: Consulta" rows={3} className="hover:border-primary/50 focus:border-primary transition-all duration-200" />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="horas_aproximadas_cita" className="text-xs text-muted-foreground">Horas</Label>
                  <Input id="horas_aproximadas_cita" type="number" min="0" value={formulario_cita.horas_aproximadas} onChange={(e) => setFormularioCita({ ...formulario_cita, horas_aproximadas: e.target.value })} placeholder="0" className="hover:border-primary/50 focus:border-primary transition-all duration-200" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="minutos_aproximados_cita" className="text-xs text-muted-foreground">Minutos</Label>
                  <Input id="minutos_aproximados_cita" type="number" min="1" value={formulario_cita.minutos_aproximados} onChange={(e) => setFormularioCita({ ...formulario_cita, minutos_aproximados: e.target.value })} placeholder="30" className="hover:border-primary/50 focus:border-primary transition-all duration-200" />
                </div>
              </div>
              <p className="text-xs text-muted-foreground">Tiempo estimado (para conflictos)</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="estado_pago_cita">Estado Pago</Label>
                <Combobox opciones={opciones_estados} valor={formulario_cita.estado_pago} onChange={(valor) => setFormularioCita({ ...formulario_cita, estado_pago: valor })} placeholder="Estado" />
              </div>

              <div className="space-y-2">
                <Label htmlFor="monto_cita">Monto (Bs.)</Label>
                <Input id="monto_cita" type="number" step="0.01" min="0" value={formulario_cita.monto_esperado} onChange={(e) => setFormularioCita({ ...formulario_cita, monto_esperado: e.target.value })} placeholder="0.00" className="hover:border-primary/50 focus:border-primary transition-all duration-200" />
              </div>
            </div>
            ...
            {formulario_cita.estado_pago === 'pagado' && parseFloat(formulario_cita.monto_esperado) > 0 && (
              <div className="p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                <p className="text-xs text-green-600 dark:text-green-400 flex items-center gap-2">
                  <DollarSign className="h-3 w-3" />
                  Registrará ingreso de {formatearMoneda(parseFloat(formulario_cita.monto_esperado))}
                </p>
              </div>
            )}
          ...
          <DialogFooter className="flex-col sm:flex-row">
            <Button variant="outline" onClick={() => setDialogoCitaAbierto(false)} disabled={guardando} className="w-full sm:w-auto">Cancelar</Button>
            <Button onClick={manejarGuardarCita} disabled={guardando} className="w-full sm:w-auto">
              {guardando && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
        ...
        <DialogContent className="sm:max-w-[425px]">
          ...
          {cita_a_eliminar && (
            <div className="p-4 rounded-lg bg-secondary/30 border border-border space-y-2">
              ...
              <p className="text-sm text-muted-foreground">{formatearFechaHora(cita_a_eliminar.fecha)}</p>
          ...
          <div className="p-3 rounded-lg bg-destructive/10 border border-destructive/20">
            <p className="text-sm text-destructive">No se puede deshacer.</p>
          </div>

          <DialogFooter className="flex-col sm:flex-row">
            <Button variant="outline" onClick={() => { setDialogoConfirmarEliminarAbierto(false); setCitaAEliminar(null); setTratamientoSeleccionado(null); }} className="w-full sm:w-auto">Cancelar</Button>
            <Button variant="destructive" onClick={() => { if (cita_a_eliminar) { confirmarEliminarCita(); } else if (tratamiento_seleccionado) { confirmarEliminarPlantilla(); } }} className="w-full sm:w-auto">Eliminar</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
