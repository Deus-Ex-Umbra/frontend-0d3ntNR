        ...
        <div className="p-4 md:p-8 space-y-6 md:space-y-8">
          ...
          <Tabs defaultValue="perfil" className="w-full">
            <TabsList className="grid w-full grid-cols-4 h-11">
              <TabsTrigger value="perfil" className="text-sm md:text-base">
                <User className="h-4 w-4 mr-1 md:mr-2" />
                Perfil
              </TabsTrigger>
              <TabsTrigger value="notas" className="text-sm md:text-base">
                <Bell className="h-4 w-4 mr-1 md:mr-2" />
                Notas
              </TabsTrigger>
              <TabsTrigger value="apariencia" className="text-sm md:text-base">
                <Palette className="h-4 w-4 mr-1 md:mr-2" />
                Tema
              </TabsTrigger>
              <TabsTrigger value="catalogos" className="text-sm md:text-base">
                ...
                <CardContent className="space-y-6">
                  <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
                    <div className="relative group">
                      <div className="h-20 w-20 md:h-24 md:w-24 rounded-full bg-gradient-to-br from-primary to-primary/70 flex items-center justify-center text-2xl md:text-3xl font-bold text-primary-foreground shadow-lg group-hover:scale-110 transition-transform duration-200">
                        {usuario?.avatar ? (
                          <img src={usuario.avatar} alt="Avatar" className="h-20 w-20 md:h-24 md:w-24 rounded-full object-cover" />
                        ) : (
                      ...
                      <label 
                        ...
                        className="absolute bottom-0 right-0 p-1 md:p-2 bg-primary rounded-full cursor-pointer hover:scale-110 hover:shadow-[0_0_15px_rgba(59,130,246,0.5)] transition-all duration-200"
                      >
                    ...
                    <div className="flex-1 text-center md:text-left">
                      <p className="text-xs md:text-sm text-muted-foreground mb-2">
                        Clic en cámara para cambiar avatar
                      </p>
                  ...
                  <Button 
                    ...
                    disabled={guardando}
                    className="hover:shadow-[0_0_15px_rgba(59,130,246,0.4)] hover:scale-105 transition-all duration-200 w-full"
                  >
                    {guardando ? (
                      <>
              ...
              <Card className="border-2 border-border shadow-lg hover:shadow-[0_0_20px_rgba(59,130,246,0.2)] transition-all duration-300">
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <CardTitle className="text-lg md:text-xl">Nueva Nota</CardTitle>
                      <CardDescription>Registra pensamientos del día</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="space-y-6">
                    ...
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-4 gap-4 md:gap-0">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Genera frase basada en últimas 7 notas
                        </p>
                      </div>
                      <Button
                        ...
                        variant="outline"
                        className="hover:bg-primary/20 hover:scale-105 transition-all duration-200 w-full md:w-auto"
                      >
                        {cargando_frase ? (
                          <>
                            <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                ...
                <CardHeader>
                  <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-0">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <CardTitle className="text-lg md:text-xl">Notas Anteriores</CardTitle>
                        <CardDescription>
                          Últimos {dias_mostrar} días
                        </CardDescription>
                      </div>
                    </div>
              ...
              <Card className="border-2 border-border shadow-lg hover:shadow-[0_0_20px_rgba(59,130,246,0.2)] transition-all duration-300">
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <CardTitle className="text-lg md:text-xl">Tema de la Aplicación</CardTitle>
                      <CardDescription>Selecciona el tema que prefieras</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                        ...
                        {temas.map((tema_opcion) => {
                          ...
                          return (
                            <button
                              ...
                              className={`p-4 md:p-5 rounded-lg border-2 transition-all duration-200 hover:scale-105 ${
                                esta_activo
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-muted-foreground mt-2">
                          Cambios se aplican inmediatamente y se guardan automáticamente.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <Card className="border-2 border-border shadow-lg hover:shadow-[0_0_20px_rgba(59,130,246,0.2)] transition-all duration-300">
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <CardTitle className="text-lg md:text-xl">Gestión de Catálogos</CardTitle>
                      <CardDescription>Administra opciones para pacientes</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="space-y-8">
                  <GestionCatalogoMovil
                    titulo="Alergias"
                    items={alergias}
