      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-4 md:p-8 space-y-6 md:space-y-8">
          <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4 md:gap-0">
            ...
            <Button size="default" className="shadow-lg hover:shadow-[0_0_20px_rgba(59,130,246,0.4)] hover:scale-105 transition-all duration-200 self-end md:self-auto" onClick={abrirDialogoNuevo}>
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <CardTitle className="text-lg md:text-xl">Búsqueda de Pacientes</CardTitle>
          ...
          <Card className="border-2 border-border shadow-lg hover:shadow-[0_0_20px_rgba(59,130,246,0.2)] transition-all duration-300">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-lg md:text-xl">Lista de Pacientes</CardTitle>
                ...
                <div className="flex gap-2 flex-wrap">
                  {catalogos.colores.filter(c => c.color).map((color) => (
                    <button
                      key={color.id}
                      type="button"
                      className={`group relative w-10 h-10 md:w-12 md:h-12 rounded-lg border-2 transition-all hover:scale-110 ${
                  ...
                  {formulario.color_categoria && (
                    <button
                      type="button"
                      className="w-10 h-10 md:w-12 md:h-12 rounded-lg border-2 border-border bg-secondary hover:bg-secondary/80 flex items-center justify-center hover:scale-110 transition-all duration-200"
        ...
        <DialogContent className="sm:max-w-[450px]">
          ...
          <DialogFooter className="flex-col sm:flex-row">
            ...
            <Button 
              ...
              className="bg-green-500 hover:bg-green-600 text-white hover:shadow-[0_0_15px_rgba(34,197,94,0.4)] hover:scale-105 transition-all duration-200 w-full sm:w-auto"
            >
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          {paciente_seleccionado && (
            <div className="space-y-6">
              <div className="flex flex-col md:flex-row items-center gap-4 p-4 bg-secondary/30 rounded-lg hover:bg-secondary/50 transition-colors duration-200">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      {paciente_seleccionado.telefono ? (
                        <div className="flex items-center gap-2 mt-1 flex-col md:flex-row">
                          ...
                          <Button
                            ...
                            className="hover:bg-green-500/20 hover:text-green-500 hover:border-green-500 transition-all duration-200 w-full md:w-auto"
                          >
