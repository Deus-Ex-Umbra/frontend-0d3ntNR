...
interface GestorArchivosMovilProps {
  paciente_id: number;
...
export function GestorArchivosMovil({ paciente_id, plan_tratamiento_id, modo = 'paciente' }: GestorArchivosMovilProps) {
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-base md:text-lg font-semibold">Archivos Adjuntos</h3>
              ...
              <CardContent className="p-3 md:p-4">
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-0">
                  <div className="flex items-center gap-3 flex-1">
                    <div className="text-2xl md:text-3xl">{obtenerIconoTipo(archivo.tipo_mime)}</div>
                    <div className="flex-1 min-w-0">
                      <p className="font-medium truncate text-sm md:text-base">{archivo.nombre_archivo}</p>
                      {archivo.descripcion && (
      ...
      <Dialog open={dialogo_subir_abierto} onOpenChange={setDialogoSubirAbierto}>
        <DialogContent className="sm:max-w-[500px]">
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Tipos permitidos: PDF, JPG, PNG, GIF, WEBP • Máx: 10MB
              </p>
            </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Input
                      ...
                      disabled
                      className="w-16 md:w-20 bg-secondary cursor-not-allowed"
                    />
                  </div>
                  <p className="text-xs text-muted-foreground">
          ...
          <DialogFooter className="flex-col sm:flex-row">
            ...
            <Button onClick={manejarSubir} disabled={subiendo || !formulario.archivo} className="w-full sm:w-auto">
      ...
      <Dialog open={dialogo_editar_abierto} onOpenChange={setDialogoEditarAbierto}>
        <DialogContent className="sm:max-w-[500px]">
          ...
          <DialogFooter className="flex-col sm:flex-row">
            ...
            <Button onClick={manejarEditar} className="w-full sm:w-auto">
              Actualizar
            </Button>
          </DialogFooter>
        </DialogContent>
      ...
      <Dialog open={dialogo_ver_abierto} onOpenChange={setDialogoVerAbierto}>
        <DialogContent className="max-w-5xl max-h-[90vh] overflow-hidden flex flex-col">
          <DialogHeader>
            <div className="flex items-center justify-between">
              <DialogTitle className="truncate pr-4">{archivo_seleccionado?.nombre_archivo}</DialogTitle>
              <div className="flex gap-2">
            ...
            {archivo_seleccionado?.descripcion && (
              <p className="text-sm text-muted-foreground mt-2">{archivo_seleccionado.descripcion}</p>
            )}
          </DialogHeader>
      ...
      <Dialog open={dialogo_confirmar_eliminar_abierto} onOpenChange={setDialogoConfirmarEliminarAbierto}>
        <DialogContent className="sm:max-w-[425px]">
          ...
          {archivo_a_eliminar && (
            <div className="p-3 md:p-4 rounded-lg bg-secondary/30 border border-border space-y-2">
          ...
          <div className="p-2 md:p-3 rounded-lg bg-destructive/10 border border-destructive/20">
